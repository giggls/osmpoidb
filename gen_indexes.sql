...
CREATE INDEX osm_poi_line_osm_id_idx ON osm_poi_line USING btree(osm_id);

CREATE INDEX osm_poi_camp_siterel_member_id_idx ON osm_poi_camp_siterel USING btree(member_id);
